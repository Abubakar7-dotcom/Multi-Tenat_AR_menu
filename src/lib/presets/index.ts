...
export const presets: Preset[] = [
  {
    ...
    config: {
      ...
      sections: [
        { id: "sec-deals", type: "deals_carousel", settings: { heading: "Today's Deals" }, hidden: false },
        { id: "sec-showcase", type: "category_showcase", settings: {}, hidden: false },
        { id: "sec-menu", type: "menu_grid", settings: {}, hidden: false },
        { id: "sec-footer", type: "footer_info", settings: {}, hidden: false },
      ],
    },
  },
  {
    ...
    config: {
      ...
      sections: [
        { id: "sec-hero", type: "hero_banner", settings: {}, hidden: false },
        { id: "sec-showcase", type: "category_showcase", settings: { columns: 4 }, hidden: false },
        { id: "sec-menu", type: "menu_grid", settings: { showDescription: "full" }, hidden: false },
        { id: "sec-heritage", type: "heritage_story", settings: {}, hidden: false },
        { id: "sec-footer", type: "footer_info", settings: { showNewsletter: true }, hidden: false },
      ],
    },
  },
  {
